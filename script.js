...
// ===== FOOTER QUOTES =====
const footerQuotes = [
  "Что разум человека может постигнуть и во что он может поверить, того он способен достичь.<br><span class='footer-quote-author'><i>Наполеон Хилл</i></span>",
  "Стремитесь не к успеху, а к ценностям, которые он дает.<br><span class='footer-quote-author'><i>Альберт Эйнштейн</i></span>",
  "Своим успехом я обязана тому, что никогда не оправдывалась и не принимала оправданий от других.<br><span class='footer-quote-author'><i>Флоренс Найтингейл</i></span>",
  "80% успеха — это появиться в нужном месте в нужное время.<br><span class='footer-quote-author'><i>Вуди Аллен</i></span>",
  "Ваше время ограничено, не тратьте его, живя чужой жизнью.<br><span class='footer-quote-author'><i>Стив Джобс</i></span>",
  "Побеждает тот, кто не боится проиграть.<br><span class='footer-quote-author'><i>Федор Емельяненко</i></span>"
];
const footerQuotesKZ = [
  "Қателікпен не істеу керек: тану, қабылдау, сабақ алу, ұмыту.<br><span class='footer-quote-author'><i>Дин Смит</i></span>",
  "Сіз сенетін нәрсе сіздің әлеміңізге айналады.<br><span class='footer-quote-author'><i>Ричард Матесон</i></span>",
  "Тек әрекет арқылы ғана сенім өз күшін алады.<br><span class='footer-quote-author'><i>Вильям Джеймс</i></span>",
  "Білім – болашақтың валютасы.<br><span class='footer-quote-author'><i>Нил Деграсс Тайсон</i></span>",
  "Тек өзіңе сенсең ғана, биікке жетесің.<br><span class='footer-quote-author'><i>Абай Құнанбаев</i></span>",
  "Табыстың 80% – бұл өзіңді көрсету.<br><span class='footer-quote-author'><i>Вуди Аллен</i></span>"
];
